...
},{"buffer":"../node_modules/buffer/index.js"}],"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
searchBox.addEventListener('input', (0, _lodash.debounce)(event => {
  event.preventDefault();

  if (searchBox.value) {
    const name = searchBox.value.trim();
    return (0, _fetchCountries.fetchCountries)(name).then(showCountries).catch(error);
  } else {
...
function showCountries(countries) {
  ...
  if (countries.length > 10) {
    return _notiflix.default.Notify.info('Too many matches found. Please enter a more specific name.', DEBOUNCE_DELAY);
  }
...
function markupInfo(countries) {
  const markupInfo = countries.map(_ref => {
    let {
      name,
      flags
    } = _ref;
...
function markupList(countries) {
  countries.map(_ref2 => {
    ...
    const markup = `<h1><img src="${flags.svg}" alt="Flag of ${name.official}" style="height: 120px; width: 160px"> ${name.official}</h1>
...
function error() {
  return _notiflix.default.Notify.failure('Oops, there is no country with that name', DEBOUNCE_DELAY);
}

;
},{"./css/styles.css":"css/styles.css","./fetchCountries":"fetchCountries.js","lodash":"../node_modules/lodash/lodash.js","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
